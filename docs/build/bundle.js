    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file, 9, 8, 375);
    			attr_dev(img1, "class", "");
